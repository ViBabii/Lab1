"""
Django settings for ProjectPP project.
...
SECRET_KEY = 'django-insecure-q_e+tm@z$yal)_hbti4=tdxj$du$f_zuu1l81s+#9y5fh234%0'
...
WSGI_APPLICATION = 'ProjectPP.wsgi.application'
